...
if ! command -v python3 &> /dev/null; then
    ...
    echo ""
    echo "Instala con: sudo apt-get install python3 python3-pip"
    echo ""
...
xdg-open "$DIR/frontend/index.html" 2>/dev/null || firefox "$DIR/frontend/index.html" 2>/dev/null || google-chrome "$DIR/frontend/index.html" 2>/dev/null
